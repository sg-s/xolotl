...
%   /_/\_\___/|_|\___/ \__|_|
%
% help: estimates inactivation function given Voltage, Current or conductances
% 

function [] = findInactivationFunction(varargin)
...
for i = 1:length(options.p)
	...
	ff = fit(vectorise(x),vectorise(y),boltz,'StartPoint',[80, 5],'MaxIter',2e9);
