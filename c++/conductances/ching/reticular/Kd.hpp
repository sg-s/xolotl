...
// _/\_ |__| |___ |__|  |  |___
//
// fast potassium current for generic thalamic reticular cells
...
double Kd::m_a(double V, double Ca) {return .032*(15.-(X+55.))/(exp((15.-(X+55.))/5.)-1.);}
double Kd::m_b(double V, double Ca) {return .5*exp((10.-(X+55.))/40.);}
