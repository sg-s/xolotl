...
// _/\_ |__| |___ |__|  |  |___
//
// fast sodium current for generic thalamocortical relay cells
...
double NaV::m_a(double V, double Ca) {return (.32*(13.-(V+35.)))/(exp((13.-(V+35.))/4.)-1.);}
double NaV::m_b(double V, double Ca) {return (.28*((V+35.)-40.))/(exp(((V+35.)-40.)/5.)-1.);}
double NaV::h_a(double V, double Ca) {return .128*exp((17-(V+35.))/18.);}
double NaV::h_b(double V, double Ca) {return 4./(1.+exp((40.-(V+35.))/5.));}
